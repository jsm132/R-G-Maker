...
function init(){
    ...
    myDiagram =
        ...
        {
            isReadOnly: true, layout: $(go.TreeLayout, // el diagrama se muestra en forma de árbol
    ...
    var activityTemplate = 
        $(go.Node, "Auto",
            ...
            $(go.TextBlock,
                {margin: 6, font: "18px sans-serif", editable: true, isMultiline: false}, // el atributo editable permite editar el texto de los nodos
    ...
    { margin: 2 },
        $(go.TextBlock,
        { editable: true, font: "18px sans-serif" },
